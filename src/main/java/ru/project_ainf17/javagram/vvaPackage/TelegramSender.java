package ru.project_ainf17.javagram.vvaPackage;
...
public class TelegramSender {
    ...
    private static final String GATEWAY_URL = "https://api.telegram.org/" + INSTANCE_ID;
    ...
    public static void main(String[] args) throws Exception {
        String number = "+987987";  // Specify the recipient's number (NOT the gateway number) here.
